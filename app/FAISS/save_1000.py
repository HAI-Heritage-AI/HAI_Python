...
faiss.write_index(index, "faiss_index_1000.bin")
print("FAISS 인덱스를 'faiss_index_1000.bin' 파일로 저장했습니다.")

# 5. 메타데이터를 파일로 저장하기
with open("faiss_metadata_1000.pkl", "wb") as f:
    pickle.dump(original_ids, f)
print("메타데이터를 'faiss_metadata_1000.pkl' 파일로 저장했습니다.")